...
point_cloud_range_ =  [0, -40, -3, 70.4, 40, 1]

custom_imports = dict(
    imports=['mvat_roi_head'], # File name without .py
...
model = dict(
    ...
    rpn_head=dict(
        ...
        anchor_generator=dict(
            ...
            ranges=[point_cloud_range_, point_cloud_range_, point_cloud_range_, 
            point_cloud_range_, point_cloud_range_, point_cloud_range_,
            point_cloud_range_],
            sizes=[
        ...
        # anchor_generator=dict(
        #     type='Anchor3DRangeGenerator',
        #     ranges=[point_cloud_range_,
        #             point_cloud_range_,
        #             point_cloud_range_],
        #     sizes=[[3.9, 1.6, 1.56], [3.9, 1.6, 1.56], [3.9, 1.6, 1.56]],
        #     rotations=[0, 1.57],
        #     reshape_out=False),
...
train_pipeline = [
    dict(
        ...
        use_dim=4,
        backend_args=backend_args),
    dict(type='LoadAnnotations3D', with_bbox_3d=True, with_bbox_2d=True,
                    with_label_3d=True,
                    with_calib_matrices=True,
                    with_frames=True,
                    backend_args=backend_args),
    ...
    dict(
        ...
        keys=['points', 'gt_bboxes_3d', 'gt_labels_3d', 'gt_bboxes_2d', 'frame', 'calib_matrices'])
]
test_pipeline = [
    dict(
        type='LoadPointsFromFile',
    ...
    #         dict(
    #             type='PointsRangeFilter', point_cloud_range = [-1e5, -1e5, -1e5, 1e5, 1e5, 1e5])
    #     ]),
